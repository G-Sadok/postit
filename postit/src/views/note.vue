...
const characterCount = computed(() => cont.value.length)
        ...
        <div>
            <!-- <div class="card-header-note h-100 mx-5 mt-5 p-3">
                ...
                <div class=" py-1 px-2">
                    ...
                    <span class="small text-secondary"><i class="bi bi-clock"></i> 20 caractères </span>

                </div>

                <div v-for="cont in postit.content" class=" pt-4 px-2">
                    <p>{{ cont }}</p>
                ...
                <div>
                    <div class="d-flex gap-3 justify-content-end">
                        <router-link :to="`/note/edit/${postit._id}`"
                            class="add-postit btn btn-sm d-inline-flex zoom-effect float-end " href="#"><i
            ...
            <Note :postItId=postit._id :title=postit.title :content=postit.content :dateCreate=createdAt :hourCreate=createdHour :characters=characterCount />
