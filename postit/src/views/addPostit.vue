        ...
        <form @submit.prevent="addPostit">
            <div>
                <div class="card-header-note h-100 mx-5 mt-5 p-3">
                    ...
                    <!-- <div class="content-note py-1 px-2">
                        <h3>Bonjour ceci est</h3>
                    </div> -->

                    <div class="mb-3 ">
                        <label for="title" class="form-label ">Title</label>
                        <input v-model="title" type="text" class="form-control content-note py-1 px-2" id="title"
                            name="title" placeholder="Here is your title..." required>

                    </div>
                    <div class="mb-3">
                        <label for="content" class="form-label">Content</label>
                        <textarea v-model="content" class="form-control content-note py-1 px-2" id="content"
                            name="content" placeholder="Here is the content..." rows="10" required></textarea>
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-3">
                        <button type="submit" class="save-postit btn btn-sm d-inline-flex zoom-effect float-end "
                            href="#"><i class="bi bi-plus"></i> &nbsp; Add</button>
                        <button @click="retourPage"
